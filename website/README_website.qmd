...
```{r links, include=FALSE}
  ...
  hl_GMACS = "https://github.com/GMACS-project";
  hl_GMACS_Code1 = "https://github.com/GMACS-project/GMACS_Assessment_code";
  hl_GMACS_Code2 = "https://github.com/GMACS-project/GMACS_tpl-cpp_code.git";
  hl_R     = "https://www.r-project.org/";
```

# wtsGMACS

`wtsGMACS` is an R package to deal with GMACS assessment data and results.
...
[![pages-build-deployment](https://github.com/wStockhausen/rtmbGMACS/actions/workflows/pages/pages-build-deployment/badge.svg?branch=gh-pages)](https://github.com/wStockhausen/rtmbGMACS/actions/workflows/pages/pages-build-deployment)
